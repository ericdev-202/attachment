# Generated by Django 3.1.6 on 2022-01-23 14:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('assessed', 'assessed'), ('notassessed', 'notassessed')], default='notassessed', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField()),
                ('staff', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='attach.staff')),
                ('student', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='attach.studentdetails')),
            ],
        ),
        migrations.CreateModel(
            name='Elogbook',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('company', models.ForeignKey(blank=True, default=1, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='attach.compdetails')),
        ...
        migrations.AddField(
            ...
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='attach.studentdetails'),
        ),
    ]
